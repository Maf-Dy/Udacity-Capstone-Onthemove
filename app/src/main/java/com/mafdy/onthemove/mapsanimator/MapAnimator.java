package com.mafdy.onthemove.mapsanimator;
...
public class MapAnimator {
    ...
    static final int GREY = Color.parseColor("#00b5e1");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        try {
            ...
            optionsForeground = new PolylineOptions().add(bangaloreRoute.get(0)).color(Color.BLACK).width(7);
